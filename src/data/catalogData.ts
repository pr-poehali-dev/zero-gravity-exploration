...
export const catalogGroups: CatalogGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Сухой фонтан с водными струями", subcategory: "Настенные и питьевые фонтаны", image: "https://cdn.poehali.dev/projects/3a0b226a-fb58-4fd0-9a57-4e73054e7090/files/cda4528b-6dba-4a4e-b468-bef3b00616e5.jpg" },
